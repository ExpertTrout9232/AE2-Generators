...
public class Ae2GeneratorsModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> WIND_GENERATOR = register("wind_generator", Ae2GeneratorsModBlocks.WIND_GENERATOR, WindGeneratorBlockEntity::new);
